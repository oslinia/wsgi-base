...
class TestModule(unittest.TestCase):
    def test_dirname(self):
        ...
        self.assertEqual(os.path.dirname(__file__), static.dirname)
    ...
    def test_urlpath(self):
        ...
        Service(__name__, static_urlpath='/path/to/file/')

        self.assertEqual('/path/to/file/', static.urlpath)

        with self.assertRaises(ValueError) as context:
            Service(__name__, static_urlpath='')
        ...
        with self.assertRaises(ValueError) as context:
            Service(__name__, static_urlpath='slash/')
